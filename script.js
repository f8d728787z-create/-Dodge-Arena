...
const onlineSaveStatus =
    document.getElementById("onlineSaveStatus");
...
async function loadOnlineLeaderboard() {
    ...
    if (error) {
        ...
        leaderboardStatus.textContent =
            "⚠️ Online-Bestenliste nicht erreichbar";
...
function submitOnlineScore(final) {
        ...
        .then(
            ({ error }) => {
                ...
                if (error) {
                    ...
                    onlineSaveStatus.textContent =
                        "⚠️ Online-Speichern fehlgeschlagen";

                } else {

                    onlineSaveStatus.textContent =
                        "✅ Score online gespeichert!";
                }
            }
        );
}
